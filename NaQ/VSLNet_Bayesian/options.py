...
def read_command_line():
    ...
    parser.add_argument(
        "--fv", type=str, default="EgoVLPv2_video_NO_head", help="[new | org] for visual features"
    )
    parser.add_argument(
        "--max_pos_len",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="gradual mlp to reduce video feature dimension",
    )
    parser.add_argument(
        "--load_omnivore",
        type=int,
        default=1,
        help="load omnivore features",  
    )
    parser.add_argument(
        "--num_workers",
        type=int,
